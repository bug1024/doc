 ...
 * 作为应用监控方向的负责人，负责Hawk应用监控系统的设计开发与推广，接入项目从最初的20多个推广到了500多个，是公司Java团队使用最广泛的监控系统，接收数据的峰值超过100万QPS
 ...
 * 引入了session降级策略，在session缓存不可用的极端情况下改从cookie里获取信息，最大限度保证B端系统的可用性
